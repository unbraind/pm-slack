...
- Gate CI on pm health so a silently discarded peer edit cannot merge ([pm-slack-k8yl](https://github.com/unbraind/pm-slack/blob/main/.agents/pm/chores/pm-slack-k8yl.toon))
